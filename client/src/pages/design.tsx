      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/design-editor">
            <span className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-md shadow-sm cursor-pointer inline-block">
              Create New Design
            </span>
          </Link>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {designs.slice(0, 6).map((design) => (
                <Link key={design.id} href={`/design-editor/${design.id}`}>
                  <div className="border border-secondary-200 rounded-lg overflow-hidden hover:shadow-md transition block cursor-pointer">
